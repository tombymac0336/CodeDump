...
#       Reviewer: tm
#       Date: 06/24/2014
#       Description: Check for Registry Value.  "Registered Owner" 
#       for Windows Server Install
##########################################################################
...
$smtphost = "MSMSGEX10WPRD01.lowes.com" 
$from = "Thomas.G.McNeil@Lowes.com" 
$to = "Thomas.G.McNeil@Lowes.com" 
